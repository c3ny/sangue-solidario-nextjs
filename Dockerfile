...
ARG NEXT_PUBLIC_FEATURE_CAMPAIGNS
ARG NEXT_PUBLIC_MAPBOX_TOKEN
ARG NEXT_PUBLIC_GOOGLE_CLIENT_ID
ARG NEXT_PUBLIC_SITE_URL
ARG NEXT_PUBLIC_FEATURE_APPOINTMENTS
ARG NEXT_PUBLIC_APPOINTMENTS_SERVICE_URL
...
ENV NEXT_PUBLIC_FEATURE_CAMPAIGNS=$NEXT_PUBLIC_FEATURE_CAMPAIGNS
ENV NEXT_PUBLIC_MAPBOX_TOKEN=$NEXT_PUBLIC_MAPBOX_TOKEN
ENV NEXT_PUBLIC_GOOGLE_CLIENT_ID=$NEXT_PUBLIC_GOOGLE_CLIENT_ID
ENV NEXT_PUBLIC_SITE_URL=$NEXT_PUBLIC_SITE_URL
ENV NEXT_PUBLIC_FEATURE_APPOINTMENTS=$NEXT_PUBLIC_FEATURE_APPOINTMENTS
ENV NEXT_PUBLIC_APPOINTMENTS_SERVICE_URL=$NEXT_PUBLIC_APPOINTMENTS_SERVICE_URL
