    ...
    <div className="col-lg-3 col-md-4 col-12 text-center mb-4">
      <div className="card shadow-sm p-4">
        ...
        <p className="text-muted mb-1">
          Responsável cadastrado: <span className="text-danger">Ricardo Souza</span>
        </p>
        <p className="text-muted mb-2">Perfil criado em: 01/01/2023</p>
        <a href="#" className="btn btn-danger btn-sm">Criar Solicitação</a>
      </div>
    </div>
      ...
      <div className="row mb-2">
        ...
        <div className="col-lg-4 col-md-12 mb-3">
          <div className="card shadow-sm p-3">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="status-bar-container">
                <div className="status-bar" style={{ width: "85%" }}></div>
              </div>
      ...
      <div className="row mb-2">
        <div className="col-lg-4 col-md-12 mb-3">
          <div className="card shadow-sm p-3">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="status-bar-container">
                <div className="status-bar" style={{ width: "60%" }}></div>
              </div>
        ...
        <div className="col-lg-4 col-md-12 mb-3">
          <div className="card shadow-sm p-3">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="status-bar-container">
                <div className="status-bar" style={{ width: "43%" }}></div>
              </div>
        ...
        <div className="col-lg-4 col-md-12 mb-3">
          <div className="card shadow-sm p-3">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="status-bar-container">
                <div className="status-bar" style={{ width: "55%" }}></div>
              </div>
      ...
      <div className="row mb-2">
        <div className="col-lg-4 col-md-12 mb-3">
          <div className="card shadow-sm p-3">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="status-bar-container">
                <div className="status-bar" style={{ width: "72%" }}></div>
              </div>
      ...
      <div className="card shadow-sm p-4">
        ...
        <form>
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="nomeInstituicao" defaultValue="Colsan Sorocaba" required />
          </div>
          <div className="mb-3">
            <label htmlFor="nomeResponsavel" className="form-label">Responsável pela conta</label>
            <input type="text" className="form-control" id="nomeResponsavel" defaultValue="Ricardo Souza" required />
          </div>
          <div className="mb-3">
            <label htmlFor="telefone" className="form-label">Telefone</label>
            <input type="text" className="form-control" id="telefone" defaultValue="(11) 98765-4321" required />
          </div>
          <div className="mb-3">
            <label htmlFor="endereco" className="form-label">Endereço</label>
            <input type="text" className="form-control" id="endereco" defaultValue="Av. Comendador Pereira Inácio, 564" required />
          </div>
          <hr />
          <div className="mb-3">
            <label htmlFor="email" className="form-label">Email de login</label>
            <input type="email" className="form-control" id="email" defaultValue="lolomoraes@gmail.com" required />
          </div>
          <div className="mb-4">
            <label htmlFor="password" className="form-label">Senha</label>
            <input type="password" className="form-control" id="password" defaultValue="123456" required />
          </div>
          <button type="submit" className="btn btn-danger w-100">Salvar Alterações</button>
        </form>
      </div>
    </div>
  </div>
          ...
          <table className="table table-striped table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td>12/10/2024</td>
                <td>07:30</td>
                <td><span className="text-danger">A+</span></td>
              </tr>
              <tr>
                <td>Tatiane Moscardi</td>
                <td>12/10/2024</td>
                <td>07:45</td>
                <td><span className="text-danger">B+</span></td>
              </tr>
              <tr>
                <td>Sabrina Fernandes</td>
                <td>12/10/2024</td>
                <td>08:00</td>
                <td><span className="text-danger">O-</span></td>
              </tr>
              <tr>
                <td>Diego Mendes</td>
                <td>12/10/2024</td>
                <td>09:00</td>
                <td><span className="text-danger">AB+</span></td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title" id="editProfileModalLabel">Editar Perfil</h5>
        ...
        <div className="modal-body">
          <form>
            <div className="mb-3 text-center">
              ...
              <input type="file" className="form-control" id="profilePhoto" accept="image/*" />
            </div>
            <div className="mb-3">
              <label htmlFor="nomeCompleto" className="form-label">Nome Completo</label>
              <input type="text" className="form-control" id="nomeCompleto" defaultValue="Heloisa Moraes" required />
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              <label htmlFor="email" className="form-label">Email de login</label>
              <input type="text" className="form-control" id="email" defaultValue="lolomoraes@gmail.com" required />
            </div>
            <div className="mb-4">
              <label htmlFor="password" className="form-label">Senha</label>
              <input type="password" className="form-control" id="password" defaultValue="123456" required />
